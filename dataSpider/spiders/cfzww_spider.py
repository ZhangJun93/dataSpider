...
class CFZWWSpider(BaseSpider):
    name = "cfzww_spider"
    website = u"财富中文网"
    allowed_domains = ['fortunechina.com']
    start_urls = ['http://www.fortunechina.com/business/finance.htm']

    rules = [
        Rule(LinkExtractor(allow=('/finance')), follow=True),
        Rule(LinkExtractor(allow=(r'/content')), callback='parse_item'),
    ]
    ...
    def parse_item(self, response):
        ...
        try:
            ...
            date = response.xpath(r'//*[@id="timespan"]//text()').extract_first()

            content = response.xpath(r'//*[@class="contentp1"]//text()').extract()
