...
class JQRTKSpider(BaseSpider):
    name = "jqrtk_spider"
    website = u"机器人天空"
    allowed_domains = ['robotsky.com']
    start_urls = ['http://www.robotsky.com/']
    ...
    def parse_item(self, response):
        ...
        try:
            ...
            date = response.xpath(r'//*[@class="article-meta"]/span[1]//text()').extract_first()
            if date is not None:
